...
comb_TA <- function(x, trim_factor = NULL, criterion = NULL) {
    ...
    if (is.null(x$Forecasts_Test) & is.null(x$Actual_Test)) {
        result <- structure(list(Method = "Trimmed Mean", Models = modelnames, Weights = weights, Trimming_Factor = trimf, Fitted = fitted, Accuracy_Train = accuracy_insample, 
